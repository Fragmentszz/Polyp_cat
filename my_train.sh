...
# fi
python my_train.py --exp_dir=/applications/graduate_design/model/finetuned/cat_sam --model_config=/applications/graduate_design/Polyp_cat/cat_sam/config/model/128_hfc.yaml --dataset_config=/applications/graduate_design/Polyp_cat/cat_sam/config/train_dataset.yaml
